  ...
  return (
    <nav className="bg-white border-b border-gray-200 sticky top-0 z-50">
          ...
          <div className="flex">
            ...
            <div className="hidden sm:ml-6 sm:flex sm:space-x-8">
              {NAV_LINKS.map((link) => {
                ...
                let classes = "inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors duration-200";
                ...
                if (link.special) {
                    ...
                    classes += " border-transparent text-gray-500 hover:border-blue-300 hover:text-gray-700";
                }
      ...
      <div className={`${isOpen ? 'block' : 'hidden'} sm:hidden`} id="mobile-menu">
        <div className="pt-2 pb-3 space-y-1 bg-white border-b border-gray-200 shadow-lg">
          {NAV_LINKS.map((link) => {
            const isActive = pathname === link.href;
            let classes = "block pl-3 pr-4 py-2 border-l-4 text-base font-medium focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors duration-200";

            if (link.special) {
                classes += " border-transparent text-red-600 hover:bg-red-50 hover:text-red-800";
            } else if (isActive) {
