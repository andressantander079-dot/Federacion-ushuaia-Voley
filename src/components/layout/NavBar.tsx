        ...
        <div className="sm:hidden" id="mobile-menu">
            ...
            {NAV_LINKS.map((link) => {
              ...
              return (
                <Link
                  ...
                  className={`block pl-3 pr-4 py-2 border-l-4 text-base font-medium focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 ${
                    link.special
                      ? 'border-transparent text-red-600 hover:bg-red-50 hover:border-red-700 hover:text-red-800'
                      : isActive
          ...
          <div className="pt-4 pb-4 border-t border-gray-200">
              <div className="flex items-center px-4">
                 <Link href="/acceso-clubes" onClick={() => setIsOpen(false)} className="text-base font-medium text-gray-500 hover:text-gray-800">
                    Acceso Clubes
                 </Link>
              </div>
          </div>
