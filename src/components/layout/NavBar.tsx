          ...
          <div className="flex">
            ...
            <div className="hidden sm:ml-6 sm:flex sm:space-x-8">
              {NAV_LINKS.map((link) => {
                ...
                const isEnVivo = link.href === '/en-vivo';

                let linkClasses = "inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium focus:outline-none focus:ring-2 focus:ring-offset-2";

                if (isEnVivo) {
                  linkClasses += " border-transparent text-red-600 hover:border-red-700 hover:text-red-800 focus:ring-red-500 animate-pulse motion-reduce:animate-none";
                } else {
                  linkClasses += " focus:ring-blue-500";
                  if (isActive) {
                    linkClasses += " border-blue-500 text-gray-900";
                  } else {
                    linkClasses += " border-transparent text-gray-500 hover:border-blue-500 hover:text-gray-700";
                  }
                }
