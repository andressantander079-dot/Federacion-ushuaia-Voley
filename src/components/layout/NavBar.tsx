          ...
          <div className="flex">
            ...
            <div className="hidden sm:ml-6 sm:flex sm:space-x-8">
              {NAV_LINKS.map((link) => {
                ...
                let className = "inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium focus:outline-none focus:ring-2 focus:ring-offset-2";

                if (isSpecial) {
                   className += " text-red-600 hover:text-red-800 focus:ring-red-500 animate-pulse motion-reduce:animate-none";
                   className += isActive ? " border-red-600" : " border-transparent hover:border-red-700";
                } else {
